...
declare global {
  ...
  const QuasarConfig: typeof import('./helpers/quasar')['QuasarConfig']
  const auth: typeof import('./store/auth')['default']
  const authRequests: typeof import('./mocks/requests/auth')['authRequests']
  ...
  const mockServerApi: typeof import('./common/utils/mockServerApi')['default']
